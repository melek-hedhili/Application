    ...
    return (
        <View style={styles.container}>
            ...
            <Text
                ...
                Veuillez entrer votre compte ici
      </Text>
            ...
            <TouchableOpacity
                ...
                style={{ marginTop: normalize(60) }}>
                <Text style={styles.mdp}>Mot de passe oublie?</Text>
            </TouchableOpacity>
            <TouchableOpacity
            ...
            <View
                ...
                <TouchableOpacity onPress={() => navigation.navigate('InscriptionNum')}>
                    <Text
                        style={{
                            justifyContent: 'center',
                            alignSelf: 'center',
