...
export default class NewPassword extends Component {
    ...
    PostData = async () => {
        if (
            ...
            this.state.hasNumber.test(this.state.password) == true
        ) {
            fetch('http://mysterious-badlands-16665.herokuapp.com/new-password', {
                method: 'post',
                headers: {
            ...
            console.log(
                'has number ?',
                this.state.hasNumber.test(this.state.password),
            );
            ...
            <View style={styles.container}>
                ...
                <View
                    ...
                    <Feather
                        ...
                        size={normalize(26)}
                        style={{
                            color: this.state.password.length >= 6 ? '#27AE60' : '#9FA5C0',
                        }}
                    />
                    <Text
                        style={{
                            color: this.state.password.length >= 6 ? '#2E3E5C' : '#9FA5C0',
